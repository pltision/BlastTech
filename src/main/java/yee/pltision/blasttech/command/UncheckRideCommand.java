...
public class UncheckRideCommand {
    ...
    public static void register(RegisterCommandsEvent event) {
        event.getDispatcher().register(Commands.literal("bt_ride").requires((p_265326_) -> {
    ...
    private static int mount(CommandSourceStack p_265285_, Entity p_265711_, Entity p_265339_) throws CommandSyntaxException {
        ...
        if (entity != null) {
            ...
            if(p_265339_ instanceof ServerPlayer player&&player.getServer()!=null){
